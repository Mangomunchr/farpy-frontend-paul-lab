...
const SECTIONS: InfoSection[] = [
  ...
  },
  {
    ...
    items: [
      "Normal: $0.01 per frame.",
      "Fast: $0.02 per frame where the fast queue is available.",
      "The quoted cost is frame_count multiplied by the selected rate.",
      "Example package: 8 Blender frames on Normal costs $0.08.",
      "Example package: 120 Blender frames on Normal costs $1.20.",
